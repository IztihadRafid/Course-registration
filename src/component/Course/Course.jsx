...
const Course = ({course,handleSelect, handleCreditHour}) => {
    ...
    return (
        <div className="bg-white border-2 w-96 border-solid rounded-xl">
            ...
            <button className=" w-full hover:bg-blue-900 mt-4 font-semibold bg-blue-700 text-xl text-white px-20 py-2 rounded-lg" onClick={()=>handleSelect(course,price)}>SELECT</button>
        </div>
    );
};
